...
public class DTOHelper {
    public static Customer createCustomer(final CustomerTypeEnum cType, final LocalDate date) {
    ...
    public static List<ItemDetail> createList(){
        ...
        for(int i=0;i<4;i++){
            itemList.add(ItemDetail.builder().id(1l+i).itemName("Item"+i).itemType(i%2==0? ItemTypeEnum.GROCERY: ItemTypeEnum.NORMAL).quantity(10+i).itemPrice(100d).build());
        }
        return itemList;
    }
